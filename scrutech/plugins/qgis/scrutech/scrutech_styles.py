...
_TREND_CLASSES: list[tuple[float | str, str, str]] = [
...
_DROUGHT_CLASSES: list[tuple[float | str, str, str]] = [
...
_STRESS_CLASSES: list[tuple[float | str, str, str]] = [
...
def _qml(
    ...
    cmin: float,
    cmax: float,
    stops: Sequence[tuple[float | str, str, str]],
...
_EXPOSURE_CLASSES: list[tuple[float | str, str, str]] = [
...
_NDVI_PROJECTION_CLASSES: list[tuple[float | str, str, str]] = [
...
_APTITUDE_STOPS: list[tuple[float | str, str, str]] = [
    (0.0, "#cccccc", "nulle"),
    (33.0, "#fdae61", "faible"),
    (66.0, "#a6d96a", "modérée"),
    (100.0, "#1a9850", "forte"),
...
def _paletted_qml(entries: Sequence[tuple]) -> str:
