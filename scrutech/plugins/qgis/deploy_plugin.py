...
2. copies ``scrutech/plugins/qgis/scrutech`` -> DEST;
...
Run:  python scrutech/plugins/qgis/deploy_plugin.py [DEST]
"""
...
HERE = Path(__file__).resolve().parent  # plugins/qgis/
PLUGIN_SRC = HERE / "scrutech"
VEGEVIGIE = HERE.parents[2] / "packages" / "vegevigie"
