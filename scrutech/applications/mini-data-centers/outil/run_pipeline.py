...
Usage :
    python run_pipeline.py                # tout : (re)génère les données puis exécute
    python run_pipeline.py --no-generate  # réutilise les données brutes existantes
    python run_pipeline.py --quiet        # moins de logs
"""
...
import pipeline
import pipeline_checks as tests_pipeline
